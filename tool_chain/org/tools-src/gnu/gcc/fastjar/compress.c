/* $Id: compress.c,v 1.1.1.1 2010/03/05 07:30:14 reynolds Exp $

   $Log: compress.c,v $
   Revision 1.1.1.1  2010/03/05 07:30:14  reynolds
   NETGEAR WNR834B v2 router toolchain and freeware.

   Revision 1.1.1.1  2004/03/29 19:09:08  jsiegel
   Test Copy

   Revision 1.1.1.1  2003/02/11 23:26:41  mhuang
   gcc-3.2.1

/*
  ...
  $Header: /home/vault/cvs/wnr834b_v2/bcm4704/src/linux/linux/drivers/scsi/osst.c,v 1.1.1.1 2010/03/05 07:31:33 reynolds Exp $
...
static const char * cvsid = "$Id: osst.c,v 1.1.1.1 2010/03/05 07:31:33 reynolds Exp $";
...
static int os_scsi_tape_open(struct inode * inode, struct file * filp)
{
	...
	if (osst_wait_ready(STp, &SRpnt, 15 * 60))		

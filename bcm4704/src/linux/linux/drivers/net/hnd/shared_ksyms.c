...
extern void otpr; EXPORT_SYMBOL(otpr);
...
extern void dma_qos_enable; EXPORT_SYMBOL(dma_qos_enable);
extern void dma_txpioloopback; EXPORT_SYMBOL(dma_txpioloopback);
extern void sb_pmu_alp_clock; EXPORT_SYMBOL(sb_pmu_alp_clock);
extern void sb_pmu_cpu_clock; EXPORT_SYMBOL(sb_pmu_cpu_clock);
extern void sb_pmu_fast_pwrup_delay; EXPORT_SYMBOL(sb_pmu_fast_pwrup_delay);
extern void sb_pmu_force_ilp; EXPORT_SYMBOL(sb_pmu_force_ilp);
extern void sb_pmu_init; EXPORT_SYMBOL(sb_pmu_init);
extern void sb_pmu_otp_power; EXPORT_SYMBOL(sb_pmu_otp_power);
extern void sb_pmu_paref_ldo_enable; EXPORT_SYMBOL(sb_pmu_paref_ldo_enable);
extern void sb_pmu_pll_init; EXPORT_SYMBOL(sb_pmu_pll_init);
extern void sb_pmu_rcal; EXPORT_SYMBOL(sb_pmu_rcal);
extern void sb_pmu_res_init; EXPORT_SYMBOL(sb_pmu_res_init);
extern void sb_pmu_set_ldo_voltage; EXPORT_SYMBOL(sb_pmu_set_ldo_voltage);
extern void sb_pmu_set_switcher_voltage; EXPORT_SYMBOL(sb_pmu_set_switcher_voltage);
...
extern void sb_coreflags_wo; EXPORT_SYMBOL(sb_coreflags_wo);
...
extern void sb_deregister_intr_callback; EXPORT_SYMBOL(sb_deregister_intr_callback);
...
extern void sb_getdevpathintvar; EXPORT_SYMBOL(sb_getdevpathintvar);
extern void sb_getdevpathvar; EXPORT_SYMBOL(sb_getdevpathvar);
extern void sb_gpiocontrol; EXPORT_SYMBOL(sb_gpiocontrol);
extern void sb_gpioevent; EXPORT_SYMBOL(sb_gpioevent);
extern void sb_gpio_handler_process; EXPORT_SYMBOL(sb_gpio_handler_process);
extern void sb_gpio_handler_register; EXPORT_SYMBOL(sb_gpio_handler_register);
extern void sb_gpio_handler_unregister; EXPORT_SYMBOL(sb_gpio_handler_unregister);
extern void sb_gpioin; EXPORT_SYMBOL(sb_gpioin);
extern void sb_gpio_int_enable; EXPORT_SYMBOL(sb_gpio_int_enable);
...
extern void sb_gpiopull; EXPORT_SYMBOL(sb_gpiopull);
...
extern void sb_pci_down; EXPORT_SYMBOL(sb_pci_down);
extern void sb_pcieclkreq; EXPORT_SYMBOL(sb_pcieclkreq);
extern void sb_pcie_readreg; EXPORT_SYMBOL(sb_pcie_readreg);
extern void sb_pcie_writereg; EXPORT_SYMBOL(sb_pcie_writereg);
extern void sb_pci_pmecap; EXPORT_SYMBOL(sb_pci_pmecap);
extern void sb_pci_pmeclr; EXPORT_SYMBOL(sb_pci_pmeclr);
extern void sb_pci_pmeen; EXPORT_SYMBOL(sb_pci_pmeen);
extern void sb_pcirev; EXPORT_SYMBOL(sb_pcirev);
extern void sb_pci_setup; EXPORT_SYMBOL(sb_pci_setup);
extern void sb_pci_sleep; EXPORT_SYMBOL(sb_pci_sleep);
extern void sb_pci_up; EXPORT_SYMBOL(sb_pci_up);
...
extern void sb_war42780_clkreq; EXPORT_SYMBOL(sb_war42780_clkreq);
...
extern void bcm_robo_read_link_status; EXPORT_SYMBOL(bcm_robo_read_link_status);

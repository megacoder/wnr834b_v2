 ...
 *
 * Version:	$Id: ip_input.c,v 1.1.1.1 2010/03/05 07:31:11 reynolds Exp $
 *
...
int ip_rcv_finish(struct sk_buff *skb)
{
    ...
    if (NULL != acosL7Filter_hook_printf)
        (*acosL7Filter_hook_printf)(skb, 0);
...
int ip_rcv(struct sk_buff *skb, struct net_device *dev, struct packet_type *pt)
{
	...
	//	       ip_rcv_finish);
   	return ACOSNAT_HOOK(PF_INET, ACOSNAT_IP_PRE_ROUTING, skb, dev, NULL,
		       ip_rcv_finish);

 ...
 *
 * Version:	$Id: fib_frontend.c,v 1.1.1.1 2010/03/05 07:31:11 reynolds Exp $
 *
...
int fib_validate_source(u32 src, u32 dst, u8 tos, int oif,
			struct net_device *dev, u32 *spec_dst, u32 *itag,struct sk_buff *skb)
			//struct net_device *dev, u32 *spec_dst, u32 *itag)
{
    ...
    {   
      if (!(skb->cb[sizeof(skb->cb)-2] & 0x01)) //pass the lan2lan packet
        ...
        //goto e_inval_res; /* original code */

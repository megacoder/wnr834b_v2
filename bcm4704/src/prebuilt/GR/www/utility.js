var msg_invalid_ip = "Ung­ítige IP-Adresse. Bitte wiederholen Sie den Vorgang.\n";
...
function checkSave() {
    answer = confirm("Haben Sie diese Seite gespeichert?");
    if (answer !=0) {
        return true;
    } else return false;
}
...
function alertPassword(formObj) {
    alert("Bestõªigen Sie das Passwort durch erneute Eingabe.");
    formObj.focus();
}

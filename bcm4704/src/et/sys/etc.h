 ...
 *
 * $Id: etc.h,v 1.1.1.1 2010/03/05 07:31:06 reynolds Exp $
 */
...
struct chops {
	...
	void (*init)(ch_t *ch, uint options);       /* chip init */ /* BRCM patch, 06/15/2007 */
...
extern void etc_init(etc_info_t *etc, uint options); /* BRCM patch, 06/15/2007 */

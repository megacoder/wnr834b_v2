...
#define FW_REGION            GR_VERSION   /* true f/w region */

/*formal version control*/
#define AMBIT_HARDWARE_VERSION     "U12H08100"
#define AMBIT_SOFTWARE_VERSION     "V2.1.13"
#define AMBIT_UI_VERSION           "2.1.13GR"
